...
**39 of 110 sub-phases recorded, 4 of 13 gates closed.**
...
| [3 — Text engine, viewer, fidelity scoreboard](#phase-3)        | 11/11      | ✅ done        |
...
### Arrowheads and picture borders at zoom follow the nominal width, not F2's rule

F2 measured a triangle head as ten points tall at or under a two-point line and five whole-pixel pens above it (M8, 49/49), and a picture border's whole-pixel stroke snapped to the grid half up (O4, 8/8); `markerGeometry` still scales from the nominal width and the band is not snapped. Under half a device pixel each, and only at non-integer scales.
