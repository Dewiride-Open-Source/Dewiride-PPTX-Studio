 ...
 * ```
 *
 * Writes `packages/paint/src/fills/pattern-tiles.ts` and
 * `packages/paint/src/fills/gradient-ramp.ts` from `corpus/ground-truth/fills.json`.
 ...
 * resolves it. See the long note in `tools/ground-truth/paint/fills/analyse.ts`: inverting a 2.2 power on
...
writeFileSync('packages/paint/src/fills/gradient-ramp.ts', rampFile);
...
writeFileSync('packages/paint/src/fills/pattern-tiles.ts', tileFile);
