...
claimFixtures([
  {
    ...
    sourceNote:
      'generated by tools/ground-truth/paint/blips/build-deck.ts and read back through PowerPoint ' +
      'by tools/ground-truth/paint/blips/read.ps1 as BMP exports of probe decks we wrote around our ' +
      'own procedural images; every candidate reading was scored against pixel colours sampled ' +
      'from those exports, and the file holds the scores and the readings that fit; the emitted ' +
      'JSON is passed through prettier before committing, as every generated file in this ' +
      'repository is',
    addedIn: '2.12',
  },
]);
