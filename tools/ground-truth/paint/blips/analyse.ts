...
claimFixtures([
  {
    ...
    sourceNote:
      ...
      'own procedural images; every value is a pixel colour sampled from those exports, and every ' +
      'candidate reading is scored against them; the emitted JSON is passed through prettier ' +
      'before committing, as every generated file in this repository is',
    addedIn: '2.12',
  },
]);
console.log(
