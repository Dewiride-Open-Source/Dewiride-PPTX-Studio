 ...
 *
 * ```
 * node tools/ground-truth/text/cascade/analyse.ts <work-dir>
 * ```
 *
...
import type { Situation, Source, TextProbe } from './probes.ts';
...
if (workDir === undefined)
  throw new Error('usage: tools/ground-truth/text/cascade/analyse.ts <work-dir>');
