 ...
 *
 * ```
 * node tools/ground-truth/text/metrics/analyse.ts <work-dir>
 * ```
 *
...
import type { LnSpc, Probe } from './probes.ts';
...
if (work === undefined)
  throw new Error('usage: tools/ground-truth/text/metrics/analyse.ts <work-dir>');
...
const fixture = {
  $comment:
    'Generated by tools/ground-truth/text/metrics/analyse.ts from experiment T2. Do not hand-edit: ' +
    'rebuild the probe decks, re-read them through PowerPoint, and re-run the analysis.',
  experiment: 'T2',
  subPhase: '3.2',
  adr: 'docs/adr/phase-3-text/0028-measurement-and-the-line-model.md',
...
const out = repoPath('corpus/ground-truth/text-metrics.json');
