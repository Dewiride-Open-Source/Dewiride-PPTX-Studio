...
#
#   powershell -File tools/ground-truth/model/sheets/read.ps1 -Dir <work-dir>
#
...
if (-not (Test-Path -LiteralPath $inputsPath)) {
    throw "no sheet-inputs.json in $root - run tools/ground-truth/model/sheets/build-deck.ts first"
}
