 ...
 *
 * ```
 * node tools/ground-truth/model/sheets/analyse.ts <dir> [--fixture <path>]
 * ```
 *
...
const dir = args[0];
if (dir === undefined)
  throw new Error('usage: tools/ground-truth/model/sheets/analyse.ts <dir> [--fixture <path>]');
...
/** The layout placeholder sets, transcribed from `probes.ts`, keyed by deck. */
...
/** What each probe declared on the slide, transcribed from `probes.ts`. */
...
const fixture = {
  $comment:
    ...
    'tools/ground-truth/model/sheets/analyse.ts from decks written by tools/ground-truth/model/sheets/build-deck.ts.',
  generatedIn: '2.9',
