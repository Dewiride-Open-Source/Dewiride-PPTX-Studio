 ...
 *
 * ```
 * node tools/ground-truth/analyse-sheets.ts <dir> [--fixture <path>]
 * ```
 *
...
const dir = args[0];
if (dir === undefined) throw new Error('usage: analyse-sheets.ts <dir> [--fixture <path>]');
...
const fixture = {
  $comment:
    ...
    'tools/ground-truth/analyse-sheets.ts from decks written by build-sheet-deck.ts.',
  generatedIn: '2.9',
  adr: 'docs/adr/0024-model-parse-and-resolve.md',
