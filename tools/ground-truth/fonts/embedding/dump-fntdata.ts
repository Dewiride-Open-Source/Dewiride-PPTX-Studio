 ...
 *
 * ```
 * node tools/ground-truth/fonts/embedding/dump-fntdata.ts <deck.pptx> [<deck.pptx> ...] [--json <file>]
 * ```
 *
...
import { entry, readZip, type ZipEntry } from '../../lib/zip.ts';
import { eotFontData, flagNames, readEot, EOT_FLAG, type EotHeader } from '../format/eot.ts';
import {
  NAME_ID,
  numGlyphs,
  readCoverage,
...
if (jsonOut !== undefined) {
  ...
  const fixture = {
    $comment:
      ...
      'data. See docs/adr/phase-0-foundation/0007-ground-truth.md. Generated by tools/ground-truth/fonts/embedding/dump-fntdata.ts.',
    decks: (
      all as {
        deck: string;
