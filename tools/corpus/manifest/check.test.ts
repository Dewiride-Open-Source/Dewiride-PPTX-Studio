      ...
      manifests: [
        ...one.manifests,
        {
          ...
          json: {
            ...
            collection: 'bench',
            generatedIn: '0.8',
            adr: 'docs/adr/phase-0-foundation/0008-inspect-worker-and-the-benchmark.md',
...
describe('C018-serializers', () => {
  ...
  it('fires when either layer is missing or empty', () => {
    for (const bad of [
      ...
      { container: 'tools/ground-truth/lib/zip.ts' },
      { xml: '', container: 'tools/ground-truth/lib/zip.ts' },
      { xml: 'tools/corpus/gen', container: '   ' },
      { xml: 42, container: 'tools/ground-truth/lib/zip.ts' },
      'tools/corpus/gen',
    ]) {
